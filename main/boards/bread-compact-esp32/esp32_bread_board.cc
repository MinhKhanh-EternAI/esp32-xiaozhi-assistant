...
public:
    ...
    virtual void SetPowerSaveLevel(PowerSaveLevel level) override {
        // Force PERFORMANCE (WiFi power save NONE) on ESP32 classic to prevent APB clock frequency scaling
        // from corrupting the I2C baud rate generator and causing hardware timeouts.
